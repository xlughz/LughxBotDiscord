 ...
 * 
 * This module provides structured error handling for the LughxBot application.
 * 
 * PHILOSOPHY:
 ...
 * 
 * USAGE:
 * - Throw LughxBotError for application-specific errors
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new LughxBotError(message, type, userMessage, normalizedContext);
}
